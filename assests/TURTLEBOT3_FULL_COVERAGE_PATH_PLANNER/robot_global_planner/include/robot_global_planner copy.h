...
namespace robot_global_planner
{
    ...
    public:
        ...
        static ros::Publisher cleaner_plan_pub_;
        static ros::ServiceClient plan_srv;
        ros::ServiceServer cleaning_plan_service;
        bool is_start_point_reached;
        static std::vector<geometry_msgs::PoseStamped> cleaning_plan;

    private:
        static boost::shared_ptr<nav_core::BaseGlobalPlanner> bgp;
        pluginlib::ClassLoader<nav_core::BaseGlobalPlanner> bgp_loader_;
        static robot_global_planner::GetPlanResponse pose_list_;
        bool bgp_goal, align_goal;
        static void straightPlan(geometry_msgs::PoseStamped &start, geometry_msgs::Pose &goal, std::vector<geometry_msgs::PoseStamped> &plan);
        static bool plan_cleaning(std_srvs::SetBoolRequest  &req,
                                        std_srvs::SetBoolResponse  &res);
        void publishPlan(const std::vector<geometry_msgs::PoseStamped> &path);
        static void publishcleanerPlan(const std::vector<geometry_msgs::PoseStamped> &path);
        bool initialized_;
